...
<video src="/search_before_startTransition.mp4" class="w-fill" autoplay muted loop playsinline></video>
...
<video src="/search_after_startTransition.mp4" class="w-fill" autoplay muted loop playsinline></video>
